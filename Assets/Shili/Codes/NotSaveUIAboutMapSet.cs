...
[UIPanelSetting(EUILayer.Normal, 6, true, EAssetLoadMode.Resources, "Prefab/Shili/NotSaveUIAboutMapSet")]
public class NotSaveUIAboutMapSet : UIPanel
{
    private bool save;
    ...
    public override void Close()
    {
        ...
        else
        {
            ...
            if (save) UIManager.Instance.GetUIPanel<MapSetUI>().OnSave();
